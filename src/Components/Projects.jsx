...
const projectdata = [
  {
    ...
    title: "SnapDiary App",
    description:
      "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dolore similique soluta reiciendis voluptates cum explicabo officia ex, sint saepe impedit? Quasi corrupti beatae doloremque mollitia possimus qui at expedita dolor?",
  ...
  },
  {
    ...
    description:
      "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quas ex, reiciendis maiores earum sunt cum dolor, officia laboriosam nihil corporis quia quod quaerat quam amet ipsam! Dolorem maiores dignissimos fugiat?",
    technologies: ["React", "TailWind CSS"],
  },
];
...
function ProjectCard({ project, index }) {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="Projects flex flex-col md:flex md:flex-row items-center gap-8"
    >
      <img
        src={project.image}
